...
net user ncr-support NcrSupport012$ /add
net user ncr-l3-support NL3Support012$ /add
net user ncr-level3-support NL3Support012$ /add
net user ncr-ps NcrPS012$ /add

net localgroup administrators ncr-support /add
net localgroup administrators ncr-l3-support  /add
net localgroup administrators ncr-level3-support /add
net localgroup administrators ncr-ps  /add
